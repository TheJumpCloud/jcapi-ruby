...
describe 'AppleMDMApi' do
  ...
  # unit tests for applemdms_devices_os_update_status
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [nil]
  describe 'applemdms_devices_os_update_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for applemdms_devices_schedule_os_update
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [nil]
  describe 'applemdms_devices_schedule_os_update test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
