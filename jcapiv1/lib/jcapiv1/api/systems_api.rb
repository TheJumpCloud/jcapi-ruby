  ...
  class SystemsApi
    ...
    def systems_list_with_http_info(content_type, accept, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'skip'].nil? && opts[:'skip'] < 0
        fail ArgumentError, 'invalid value for "opts[:"skip"]" when calling SystemsApi.systems_list, must be greater than or equal to 0.'
      end
    ...
    def systems_put(id, content_type, accept, opts = {})
      data, _status_code, _headers = systems_put_with_http_info(id, content_type, accept, opts)
      return data
    end
    ...
    def systems_systemusers_binding_list_with_http_info(id, content_type, accept, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'skip'].nil? && opts[:'skip'] < 0
        fail ArgumentError, 'invalid value for "opts[:"skip"]" when calling SystemsApi.systems_systemusers_binding_list, must be greater than or equal to 0.'
      end
