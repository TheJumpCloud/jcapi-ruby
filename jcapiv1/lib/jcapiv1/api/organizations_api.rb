...
module JCAPIv1
  class OrganizationsApi
    ...
    # @return [Organization]
    def organization_put(id, content_type, accept, opts = {})
      data, _status_code, _headers = organization_put_with_http_info(id, content_type, accept, opts)
      return data
    end
    ...
    def organization_put_with_http_info(id, content_type, accept, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling OrganizationsApi.organization_put"
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling OrganizationsApi.organization_put"
      end
      # resource path
    ...
    # @option opts [String] :filter A filter to apply to the query.
    # @return [nil]
    def organizations_get(id, content_type, accept, opts = {})
      organizations_get_with_http_info(id, content_type, accept, opts)
      return nil
    end
    ...
    def organizations_get_with_http_info(id, content_type, accept, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling OrganizationsApi.organizations_get"
      end
      # verify the required parameter 'accept' is set
      if @api_client.config.client_side_validation && accept.nil?
        fail ArgumentError, "Missing the required parameter 'accept' when calling OrganizationsApi.organizations_get"
      end
      # resource path
      local_var_path = "/organizations/{id}".sub('{' + 'id' + '}', id.to_s)
