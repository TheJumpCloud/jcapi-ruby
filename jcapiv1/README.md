...
```shell
gem install ./jcapiv1-1.0.1.gem
```
(for development, run `gem install --dev ./jcapiv1-1.0.1.gem` to install the development dependencies)
...
*JCAPIv1::SystemusersApi* | [**systemusers_resetmfa**](docs/SystemusersApi.md#systemusers_resetmfa) | **POST** /systemusers/{id}/resetmfa | Reset systemuser mfa
...
## Documentation for Models
 ...
 - [JCAPIv1::InlineResponse200Config](docs/InlineResponse200Config.md)
 - [JCAPIv1::InlineResponse200ConfigConstantAttributes](docs/InlineResponse200ConfigConstantAttributes.md)
 - [JCAPIv1::InlineResponse200ConfigConstantAttributesValue](docs/InlineResponse200ConfigConstantAttributesValue.md)
 - [JCAPIv1::InlineResponse200ConfigDatabaseAttributes](docs/InlineResponse200ConfigDatabaseAttributes.md)
 - [JCAPIv1::InlineResponse200ConfigIdpEntityId](docs/InlineResponse200ConfigIdpEntityId.md)
 - [JCAPIv1::InlineResponse200ConfigIdpEntityIdTooltip](docs/InlineResponse200ConfigIdpEntityIdTooltip.md)
 - [JCAPIv1::InlineResponse200ConfigIdpEntityIdTooltipVariables](docs/InlineResponse200ConfigIdpEntityIdTooltipVariables.md)
 - [JCAPIv1::InlineResponse200Results](docs/InlineResponse200Results.md)
