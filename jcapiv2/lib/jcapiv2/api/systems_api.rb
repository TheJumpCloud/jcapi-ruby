...
module JCAPIv2
  class SystemsApi
    ...
    def graph_system_traverse_policy_group_with_http_info(system_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemsApi.graph_system_traverse_policy_group ...'
      end
      # verify the required parameter 'system_id' is set
      if @api_client.config.client_side_validation && system_id.nil?
        fail ArgumentError, "Missing the required parameter 'system_id' when calling SystemsApi.graph_system_traverse_policy_group"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemsApi#graph_system_traverse_policy_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Systemfdekey, Integer, Hash)>] Systemfdekey data, response status code and response headers
    def systems_get_fde_key_with_http_info(system_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Systemfdekey' 
    ...
    # @option opts [Integer] :skip The offset into the records to return. (default to 0)
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @return [Array<SoftwareAppWithStatus>]
    def systems_list_software_apps_with_statuses(system_id, opts = {})
      data, _status_code, _headers = systems_list_software_apps_with_statuses_with_http_info(system_id, opts)
      data
    end
    ...
    # @option opts [Integer] :skip The offset into the records to return.
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @return [Array<(Array<SoftwareAppWithStatus>, Integer, Hash)>] Array<SoftwareAppWithStatus> data, response status code and response headers
    def systems_list_software_apps_with_statuses_with_http_info(system_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemsApi.systems_list_software_apps_with_statuses ...'
      end
      # verify the required parameter 'system_id' is set
      if @api_client.config.client_side_validation && system_id.nil?
        fail ArgumentError, "Missing the required parameter 'system_id' when calling SystemsApi.systems_list_software_apps_with_statuses"
      end
      # resource path
      local_var_path = '/systems/{system_id}/softwareappstatuses'.sub('{' + 'system_id' + '}', system_id.to_s)
      ...
      return_type = opts[:return_type] || 'Array<SoftwareAppWithStatus>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemsApi#systems_list_software_apps_with_statuses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
