...
# Unit tests for JCAPIv2::IPListsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IPListsApi' do
  before do
    # run before each test
    @instance = JCAPIv2::IPListsApi.new
  end
  ...
  describe 'test an instance of IPListsApi' do
    it 'should create an instance of IPListsApi' do
      expect(@instance).to be_instance_of(JCAPIv2::IPListsApi)
    end
  end

  # unit tests for iplists_delete
  # Delete an IP list
  ...
  # @return [IPList]
  describe 'iplists_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for iplists_get
  # Get an IP list
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [IPList]
  describe 'iplists_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for iplists_list
  # List IP Lists
  ...
  # @return [Array<IPList>]
  describe 'iplists_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for iplists_patch
  # Update an IP list
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [IPList]
  describe 'iplists_patch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for iplists_post
  # Create IP List
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [IPList]
  describe 'iplists_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for iplists_put
  # Replace an IP list
