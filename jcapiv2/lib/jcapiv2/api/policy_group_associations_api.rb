...
module JCAPIv2
  class PolicyGroupAssociationsApi
    ...
    def graph_policy_group_associations_list_with_http_info(group_id, targets, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupAssociationsApi.graph_policy_group_associations_list ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupAssociationsApi.graph_policy_group_associations_list"
      end
      # verify the required parameter 'targets' is set
      if @api_client.config.client_side_validation && targets.nil?
        fail ArgumentError, "Missing the required parameter 'targets' when calling PolicyGroupAssociationsApi.graph_policy_group_associations_list"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupAssociationsApi#graph_policy_group_associations_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def graph_policy_group_associations_post_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupAssociationsApi.graph_policy_group_associations_post ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupAssociationsApi.graph_policy_group_associations_post"
      end
      # resource path
      local_var_path = '/policygroups/{group_id}/associations'.sub('{' + 'group_id' + '}', group_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupAssociationsApi#graph_policy_group_associations_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_traverse_system_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupAssociationsApi.graph_policy_group_traverse_system ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupAssociationsApi.graph_policy_group_traverse_system"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupAssociationsApi#graph_policy_group_traverse_system\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_traverse_system_group_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupAssociationsApi.graph_policy_group_traverse_system_group ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupAssociationsApi.graph_policy_group_traverse_system_group"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupAssociationsApi#graph_policy_group_traverse_system_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
