...
module JCAPIv2
  class OrganizationsApi
    ...
    def organizations_org_list_cases(opts = {})
      data, _status_code, _headers = organizations_org_list_cases_with_http_info(opts)
      data
    end
    ...
    def organizations_org_list_cases_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.organizations_org_list_cases ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#organizations_org_list_cases\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
