...
module JCAPIv2
  class SoftwareAppsApi
    ...
    # @option opts [SoftwareApp] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(SoftwareAppCreate, Integer, Hash)>] SoftwareAppCreate data, response status code and response headers
    def software_apps_post_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'SoftwareAppCreate' 
    ...
    def validator_validate_application_install_package(body, opts = {})
      data, _status_code, _headers = validator_validate_application_install_package_with_http_info(body, opts)
      data
    end
    ...
    # @param body 
    # @param [Hash] opts the optional parameters
    # @return [Array<(JumpcloudPackageValidatorValidateApplicationInstallPackageResponse, Integer, Hash)>] JumpcloudPackageValidatorValidateApplicationInstallPackageResponse data, response status code and response headers
    def validator_validate_application_install_package_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SoftwareAppsApi.validator_validate_application_install_package ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SoftwareAppsApi.validator_validate_application_install_package"
      end
      # resource path
      local_var_path = '/softwareapps/validate'
      ...
      return_type = opts[:return_type] || 'JumpcloudPackageValidatorValidateApplicationInstallPackageResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SoftwareAppsApi#validator_validate_application_install_package\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
