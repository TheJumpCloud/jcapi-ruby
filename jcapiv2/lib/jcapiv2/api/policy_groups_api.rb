  ...
  class PolicyGroupsApi
    ...
    def graph_policy_group_associations_list_with_http_info(group_id, targets, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_associations_list ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_associations_list"
      end
      # verify the required parameter 'targets' is set
      if @api_client.config.client_side_validation && targets.nil?
        fail ArgumentError, "Missing the required parameter 'targets' when calling PolicyGroupsApi.graph_policy_group_associations_list"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_associations_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def graph_policy_group_associations_post_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_associations_post ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_associations_post"
      end
      # resource path
      local_var_path = '/policygroups/{group_id}/associations'.sub('{' + 'group_id' + '}', group_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_associations_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_members_list_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_members_list ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_members_list"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_members_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_members_post_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_members_post ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_members_post"
      end
      # resource path
      local_var_path = '/policygroups/{group_id}/members'.sub('{' + 'group_id' + '}', group_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_members_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_membership_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_membership ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_membership"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_membership\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_traverse_system_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_traverse_system ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_traverse_system"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_traverse_system\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def graph_policy_group_traverse_system_group_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.graph_policy_group_traverse_system_group ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling PolicyGroupsApi.graph_policy_group_traverse_system_group"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#graph_policy_group_traverse_system_group\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id ObjectID of the Policy Group.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PolicyGroup]
    def groups_policy_delete(id, opts = {})
      data, _status_code, _headers = groups_policy_delete_with_http_info(id, opts)
      data
    end
    ...
    def groups_policy_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.groups_policy_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PolicyGroupsApi.groups_policy_delete"
      end
      # resource path
      local_var_path = '/policygroups/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#groups_policy_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PolicyGroup]
    def groups_policy_get(id, opts = {})
      data, _status_code, _headers = groups_policy_get_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(PolicyGroup, Integer, Hash)>] PolicyGroup data, response status code and response headers
    def groups_policy_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.groups_policy_get ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PolicyGroupsApi.groups_policy_get"
      end
      # resource path
      local_var_path = '/policygroups/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#groups_policy_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def groups_policy_list(opts = {})
      data, _status_code, _headers = groups_policy_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<PolicyGroup>, Integer, Hash)>] Array<PolicyGroup> data, response status code and response headers
    def groups_policy_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.groups_policy_list ...'
      end
      # resource path
      local_var_path = '/policygroups'
      ...
      return_type = opts[:return_type] || 'Array<PolicyGroup>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#groups_policy_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [PolicyGroupData] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PolicyGroup]
    def groups_policy_post(opts = {})
      data, _status_code, _headers = groups_policy_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(PolicyGroup, Integer, Hash)>] PolicyGroup data, response status code and response headers
    def groups_policy_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.groups_policy_post ...'
      end
      # resource path
      local_var_path = '/policygroups'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#groups_policy_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PolicyGroup]
    def groups_policy_put(id, opts = {})
      data, _status_code, _headers = groups_policy_put_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(PolicyGroup, Integer, Hash)>] PolicyGroup data, response status code and response headers
    def groups_policy_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PolicyGroupsApi.groups_policy_put ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PolicyGroupsApi.groups_policy_put"
      end
      # resource path
      local_var_path = '/policygroups/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PolicyGroupsApi#groups_policy_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
