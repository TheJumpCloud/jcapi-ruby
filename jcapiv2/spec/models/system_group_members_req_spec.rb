...
# Unit tests for SwaggerClient::SystemGroupMembersReq
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SystemGroupMembersReq' do
  before do
    # run before each test
    @instance = SwaggerClient::SystemGroupMembersReq.new
  end
  ...
  describe 'test an instance of SystemGroupMembersReq' do
    it 'should create an instact of SystemGroupMembersReq' do
      expect(@instance).to be_instance_of(SwaggerClient::SystemGroupMembersReq)
    end
  end
