...
```shell
gem install ./jcapiv2-1.1.0.gem
```
(for development, run `gem install --dev ./jcapiv2-1.1.0.gem` to install the development dependencies)
...
*JCAPIv2::UsersApi* | [**user_send_emails**](docs/UsersApi.md#user_send_emails) | **POST** /users/{user_id}/emails | Send User Emails
...
## Documentation for Models
 ...
 - [JCAPIv2::SystemuserAttributes](docs/SystemuserAttributes.md)
