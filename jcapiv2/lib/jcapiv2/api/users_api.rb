...
module JCAPIv2
  class UsersApi
    ...
    def graph_user_traverse_active_directory_with_http_info(user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.graph_user_traverse_active_directory ...'
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersApi.graph_user_traverse_active_directory"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#graph_user_traverse_active_directory\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param user_id 
    # @param push_endpoint_id 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PushEndpointResponse]
    def push_endpoints_delete(user_id, push_endpoint_id, opts = {})
      data, _status_code, _headers = push_endpoints_delete_with_http_info(user_id, push_endpoint_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(PushEndpointResponse, Integer, Hash)>] PushEndpointResponse data, response status code and response headers
    def push_endpoints_delete_with_http_info(user_id, push_endpoint_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.push_endpoints_delete ...'
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersApi.push_endpoints_delete"
      end
      # verify the required parameter 'push_endpoint_id' is set
      if @api_client.config.client_side_validation && push_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'push_endpoint_id' when calling UsersApi.push_endpoints_delete"
      end
      # resource path
      local_var_path = '/users/{user_id}/pushendpoints/{push_endpoint_id}'.sub('{' + 'user_id' + '}', user_id.to_s).sub('{' + 'push_endpoint_id' + '}', push_endpoint_id.to_s)
      ...
      return_type = opts[:return_type] || 'PushEndpointResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#push_endpoints_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PushEndpointResponse]
    def push_endpoints_get(user_id, push_endpoint_id, opts = {})
      data, _status_code, _headers = push_endpoints_get_with_http_info(user_id, push_endpoint_id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(PushEndpointResponse, Integer, Hash)>] PushEndpointResponse data, response status code and response headers
    def push_endpoints_get_with_http_info(user_id, push_endpoint_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.push_endpoints_get ...'
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersApi.push_endpoints_get"
      end
      # verify the required parameter 'push_endpoint_id' is set
      if @api_client.config.client_side_validation && push_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'push_endpoint_id' when calling UsersApi.push_endpoints_get"
      end
      # resource path
      local_var_path = '/users/{user_id}/pushendpoints/{push_endpoint_id}'.sub('{' + 'user_id' + '}', user_id.to_s).sub('{' + 'push_endpoint_id' + '}', push_endpoint_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#push_endpoints_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<PushEndpointResponse>]
    def push_endpoints_list(user_id, opts = {})
      data, _status_code, _headers = push_endpoints_list_with_http_info(user_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<PushEndpointResponse>, Integer, Hash)>] Array<PushEndpointResponse> data, response status code and response headers
    def push_endpoints_list_with_http_info(user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.push_endpoints_list ...'
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersApi.push_endpoints_list"
      end
      # resource path
      local_var_path = '/users/{user_id}/pushendpoints'.sub('{' + 'user_id' + '}', user_id.to_s)
      ...
      return_type = opts[:return_type] || 'Array<PushEndpointResponse>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#push_endpoints_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param push_endpoint_id 
    # @param [Hash] opts the optional parameters
    # @option opts [PushendpointsPushEndpointIdBody] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [PushEndpointResponse]
    def push_endpoints_patch(user_id, push_endpoint_id, opts = {})
      data, _status_code, _headers = push_endpoints_patch_with_http_info(user_id, push_endpoint_id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(PushEndpointResponse, Integer, Hash)>] PushEndpointResponse data, response status code and response headers
    def push_endpoints_patch_with_http_info(user_id, push_endpoint_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.push_endpoints_patch ...'
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UsersApi.push_endpoints_patch"
      end
      # verify the required parameter 'push_endpoint_id' is set
      if @api_client.config.client_side_validation && push_endpoint_id.nil?
        fail ArgumentError, "Missing the required parameter 'push_endpoint_id' when calling UsersApi.push_endpoints_patch"
      end
      # resource path
      local_var_path = '/users/{user_id}/pushendpoints/{push_endpoint_id}'.sub('{' + 'user_id' + '}', user_id.to_s).sub('{' + 'push_endpoint_id' + '}', push_endpoint_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#push_endpoints_patch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
