...
module JCAPIv2
  class SystemGroupsApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SystemGroupPost] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [SystemGroup]
    ...
    # @param id ObjectID of the System Group.
    # @param [Hash] opts the optional parameters
    # @option opts [SystemGroupPut] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [SystemGroup]
    ...
    def groups_system_suggestions_get(group_id, opts = {})
      data, _status_code, _headers = groups_system_suggestions_get_with_http_info(group_id, opts)
      data
    end
    ...
    def groups_system_suggestions_get_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemGroupsApi.groups_system_suggestions_get ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling SystemGroupsApi.groups_system_suggestions_get"
      end
      # resource path
      local_var_path = '/systemgroups/{group_id}/suggestions'.sub('{' + 'group_id' + '}', group_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemGroupsApi#groups_system_suggestions_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<MemberSuggestionsPostResult>]
    def groups_system_suggestions_post(body, group_id, opts = {})
      data, _status_code, _headers = groups_system_suggestions_post_with_http_info(body, group_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<MemberSuggestionsPostResult>, Integer, Hash)>] Array<MemberSuggestionsPostResult> data, response status code and response headers
    def groups_system_suggestions_post_with_http_info(body, group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SystemGroupsApi.groups_system_suggestions_post ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling SystemGroupsApi.groups_system_suggestions_post"
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling SystemGroupsApi.groups_system_suggestions_post"
      end
      # resource path
      local_var_path = '/systemgroups/{group_id}/suggestions'.sub('{' + 'group_id' + '}', group_id.to_s)
      ...
      return_type = opts[:return_type] || 'Array<MemberSuggestionsPostResult>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemGroupsApi#groups_system_suggestions_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
