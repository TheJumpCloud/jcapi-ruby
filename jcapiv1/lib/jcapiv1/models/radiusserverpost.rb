...
module JCAPIv1
  class Radiusserverpost
    ...
    def hash
      [auth_idp, device_cert_enabled, mfa, name, network_source_ip, shared_secret, tag_names, user_cert_enabled, user_lockout_action, user_password_enabled, user_password_expiration_action].hash
    end
