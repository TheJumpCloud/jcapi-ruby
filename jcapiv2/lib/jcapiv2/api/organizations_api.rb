  ...
  class OrganizationsApi
    ...
    def administrator_organizations_create_by_administrator_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.administrator_organizations_create_by_administrator ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrganizationsApi.administrator_organizations_create_by_administrator"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#administrator_organizations_create_by_administrator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def administrator_organizations_list_by_administrator_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.administrator_organizations_list_by_administrator ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrganizationsApi.administrator_organizations_list_by_administrator"
      end
      # resource path
      local_var_path = '/administrators/{id}/organizationlinks'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#administrator_organizations_list_by_administrator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def administrator_organizations_list_by_organization_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.administrator_organizations_list_by_organization ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrganizationsApi.administrator_organizations_list_by_organization"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#administrator_organizations_list_by_organization\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def administrator_organizations_remove_by_administrator_with_http_info(administrator_id, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.administrator_organizations_remove_by_administrator ...'
      end
      # verify the required parameter 'administrator_id' is set
      if @api_client.config.client_side_validation && administrator_id.nil?
        fail ArgumentError, "Missing the required parameter 'administrator_id' when calling OrganizationsApi.administrator_organizations_remove_by_administrator"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling OrganizationsApi.administrator_organizations_remove_by_administrator"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#administrator_organizations_remove_by_administrator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def organizations_list_cases(opts = {})
      data, _status_code, _headers = organizations_list_cases_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [Integer] :limit The number of records to return at once. Limited to 100.
    # @return [Array<(OrganizationCasesResponse, Integer, Hash)>] OrganizationCasesResponse data, response status code and response headers
    def organizations_list_cases_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.organizations_list_cases ...'
      end
      # resource path
      local_var_path = '/organizations/cases'
      ...
      return_type = opts[:return_type] || 'OrganizationCasesResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#organizations_list_cases\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
