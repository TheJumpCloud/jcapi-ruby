...
module SwaggerClient
  class ApplicationsApi
    ...
    def applications_list_with_http_info(content_type, accept, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'content_type' when calling ApplicationsApi.applications_list" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling ApplicationsApi.applications_list" if accept.nil?
      # resource path
      local_var_path = "/applications".sub('{format}','json')
