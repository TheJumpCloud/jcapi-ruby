...
# Unit tests for JCAPIv2::ImportUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportUser' do
  before do
    # run before each test
    @instance = JCAPIv2::ImportUser.new
  end
  ...
  describe 'test an instance of ImportUser' do
    it 'should create an instance of ImportUser' do
      expect(@instance).to be_instance_of(JCAPIv2::ImportUser)
    end
  end
