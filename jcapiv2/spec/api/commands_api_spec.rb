...
describe 'CommandsApi' do
  ...
  # unit tests for commands_cancel_queued_commands_by_workflow_instance_id
  ...
  # @return [nil]
  describe 'commands_cancel_queued_commands_by_workflow_instance_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for commands_get_queued_commands_by_workflow
  ...
  describe 'commands_get_queued_commands_by_workflow test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
