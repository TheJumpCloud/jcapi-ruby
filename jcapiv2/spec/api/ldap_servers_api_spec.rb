...
# Unit tests for SwaggerClient::LDAPServersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LDAPServersApi' do
  before do
    # run before each test
    @instance = SwaggerClient::LDAPServersApi.new
  end
  ...
  describe 'test an instance of LDAPServersApi' do
    it 'should create an instact of LDAPServersApi' do
      expect(@instance).to be_instance_of(SwaggerClient::LDAPServersApi)
    end
  end
