...
module JCAPIv2
  class SystemInsightsCertificates
    ...
    attr_accessor :key_strength

    attr_accessor :key_usage

    attr_accessor :not_valid_after

    attr_accessor :not_valid_before
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::SystemInsightsCertificates` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::SystemInsightsCertificates`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'authority_key_id')
        self.authority_key_id = attributes[:'authority_key_id']
      end
      ...
      if attributes.key?(:'key_strength')
        self.key_strength = attributes[:'key_strength']
      end
      ...
      if attributes.key?(:'not_valid_after')
        self.not_valid_after = attributes[:'not_valid_after']
      end

      if attributes.key?(:'not_valid_before')
        self.not_valid_before = attributes[:'not_valid_before']
      end
      ...
      if attributes.key?(:'store_location')
        self.store_location = attributes[:'store_location']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          key_strength == o.key_strength &&
          key_usage == o.key_usage &&
          not_valid_after == o.not_valid_after &&
          not_valid_before == o.not_valid_before &&
          path == o.path &&
    ...
    def hash
      [authority_key_id, ca, common_name, issuer, key_algorithm, key_strength, key_usage, not_valid_after, not_valid_before, path, self_signed, serial, sha1, sid, signing_algorithm, store, store_id, store_location, subject, subject_key_id, system_id, username].hash
    end
