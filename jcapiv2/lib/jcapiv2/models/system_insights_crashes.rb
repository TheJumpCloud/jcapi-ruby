  ...
  class SystemInsightsCrashes
    ...
    def self.openapi_types
      {
        ...
        :'crash_path' => :'Object',
        :'crashed_thread' => :'Object',
        :'datetime' => :'Object',
        :'exception_codes' => :'Object',
        :'exception_notes' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::SystemInsightsCrashes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::SystemInsightsCrashes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'crash_path')
        self.crash_path = attributes[:'crash_path']
      end

      if attributes.key?(:'crashed_thread')
      ...
      if attributes.key?(:'exception_codes')
        self.exception_codes = attributes[:'exception_codes']
      end

      if attributes.key?(:'exception_notes')
        self.exception_notes = attributes[:'exception_notes']
      end

      if attributes.key?(:'exception_type')
