...
describe 'ApplicationsApi' do
  ...
  # unit tests for applications_delete_logo
  ...
  # @return [nil]
  describe 'applications_delete_logo test' do
    it 'should work' do
  ...
  # unit tests for applications_post_logo
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [nil]
  describe 'applications_post_logo test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [JobId]
  describe 'import_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for import_users
