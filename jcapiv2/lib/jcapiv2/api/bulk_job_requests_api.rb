...
module JCAPIv2
  class BulkJobRequestsApi
    ...
    # @option opts [Array<BulkUserExpire>] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [JobId]
    def bulk_user_expires(opts = {})
      data, _status_code, _headers = bulk_user_expires_with_http_info(opts)
      data
    end
    ...
    def bulk_user_expires_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BulkJobRequestsApi.bulk_user_expires ...'
      end
      # resource path
      local_var_path = '/bulk/user/expires'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BulkJobRequestsApi#bulk_user_expires\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param users A list of system user IDs, limited to 100 items.
    # @param [Hash] opts the optional parameters
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<BulkUserUnlock>] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [JobId]
    def bulk_user_unlocks(opts = {})
      data, _status_code, _headers = bulk_user_unlocks_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(JobId, Integer, Hash)>] JobId data, response status code and response headers
    def bulk_user_unlocks_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BulkJobRequestsApi.bulk_user_unlocks ...'
      end
      # resource path
      local_var_path = '/bulk/user/unlocks'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BulkJobRequestsApi#bulk_user_unlocks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Bulk Users Create
