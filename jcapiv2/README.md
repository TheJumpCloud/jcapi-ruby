...
```shell
gem install ./jcapiv2-1.0.1.gem
```
(for development, run `gem install --dev ./jcapiv2-1.0.1.gem` to install the development dependencies)
...
*JCAPIv2::BulkJobRequestsApi* | [**job_get**](docs/BulkJobRequestsApi.md#job_get) | **GET** /jobs/{id} | Get Job
*JCAPIv2::BulkJobRequestsApi* | [**job_results**](docs/BulkJobRequestsApi.md#job_results) | **GET** /jobs/{id}/results | List Job Results
...
*JCAPIv2::WorkdayImportApi* | [**workdays_settings**](docs/WorkdayImportApi.md#workdays_settings) | **GET** /workdays/settings | Get Workday Settings
...
## Documentation for Models
 ...
 - [JCAPIv2::Workdayimportresult](docs/Workdayimportresult.md)
 - [JCAPIv2::WorkdayimportresultResult](docs/WorkdayimportresultResult.md)
