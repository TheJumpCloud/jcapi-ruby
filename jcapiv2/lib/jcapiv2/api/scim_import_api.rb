  ...
  class SCIMImportApi
    ...
    def import_users_with_http_info(application_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SCIMImportApi.import_users ...'
      end
      # verify the required parameter 'application_id' is set
      if @api_client.config.client_side_validation && application_id.nil?
        fail ArgumentError, "Missing the required parameter 'application_id' when calling SCIMImportApi.import_users"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SCIMImportApi#import_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
