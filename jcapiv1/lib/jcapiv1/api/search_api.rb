  ...
  class SearchApi
    ...
    def search_organizations_post_with_http_info(content_type, accept, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'skip'].nil? && opts[:'skip'] < 0
        fail ArgumentError, 'invalid value for "opts[:"skip"]" when calling SearchApi.search_organizations_post, must be greater than or equal to 0.'
      end
    ...
    def search_systems_post_with_http_info(content_type, accept, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'skip'].nil? && opts[:'skip'] < 0
        fail ArgumentError, 'invalid value for "opts[:"skip"]" when calling SearchApi.search_systems_post, must be greater than or equal to 0.'
      end
    ...
    def search_systemusers_post_with_http_info(content_type, accept, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'skip'].nil? && opts[:'skip'] < 0
        fail ArgumentError, 'invalid value for "opts[:"skip"]" when calling SearchApi.search_systemusers_post, must be greater than or equal to 0.'
      end
