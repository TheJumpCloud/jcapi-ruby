...
module JCAPIv1
  class CommandResultsApi
    ...
    def command_results_delete(id, opts = {})
      data, _status_code, _headers = command_results_delete_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id 
    # @return [Array<(Commandresult, Integer, Hash)>] Commandresult data, response status code and response headers
    def command_results_delete_with_http_info(id, opts = {})
      ...
      return_type = opts[:return_type] || 'Commandresult' 
    ...
    # @option opts [String] :x_org_id 
    # @return [Commandresult]
    def command_results_get(id, opts = {})
      data, _status_code, _headers = command_results_get_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(Commandresult, Integer, Hash)>] Commandresult data, response status code and response headers
    def command_results_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    def command_results_list(opts = {})
      data, _status_code, _headers = command_results_list_with_http_info(opts)
      data
    end
    ...
    def command_results_list_with_http_info(opts = {})
      if @api_client.config.debugging
