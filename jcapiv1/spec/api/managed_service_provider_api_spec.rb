...
# Unit tests for JCAPIv1::ManagedServiceProviderApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManagedServiceProviderApi' do
  before do
    # run before each test
    @instance = JCAPIv1::ManagedServiceProviderApi.new
  end
  ...
  describe 'test an instance of ManagedServiceProviderApi' do
    it 'should create an instance of ManagedServiceProviderApi' do
      expect(@instance).to be_instance_of(JCAPIv1::ManagedServiceProviderApi)
    end
  end

  # unit tests for admin_totpreset_begin
  ...
  # @return [nil]
  describe 'admin_totpreset_begin test' do
    it 'should work' do
