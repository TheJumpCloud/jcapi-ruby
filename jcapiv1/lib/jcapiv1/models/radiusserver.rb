...
module JCAPIv1
  class Radiusserver
    ...
    def hash
      [_id, auth_idp, device_cert_enabled, mfa, name, network_source_ip, organization, shared_secret, tag_names, tags, user_cert_enabled, user_lockout_action, user_password_enabled, user_password_expiration_action].hash
    end
