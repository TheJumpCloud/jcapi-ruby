...
module JCAPIv2
  class CommandsApi
    ...
    # @param workflow_instance_id Workflow instance Id of the queued commands to cancel.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [nil]
    def commands_cancel_queued_commands_by_workflow_instance_id(workflow_instance_id, opts = {})
      commands_cancel_queued_commands_by_workflow_instance_id_with_http_info(workflow_instance_id, opts)
      nil
    end
    ...
    def commands_cancel_queued_commands_by_workflow_instance_id_with_http_info(workflow_instance_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommandsApi.commands_cancel_queued_commands_by_workflow_instance_id ...'
      end
      ...
      if @api_client.config.client_side_validation && workflow_instance_id.nil?
        fail ArgumentError, "Missing the required parameter 'workflow_instance_id' when calling CommandsApi.commands_cancel_queued_commands_by_workflow_instance_id"
      end
      # resource path
      local_var_path = '/commandqueue/{workflow_instance_id}'.sub('{' + 'workflow_instance_id' + '}', workflow_instance_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommandsApi#commands_cancel_queued_commands_by_workflow_instance_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :search The search string to query records
    # @return [QueuedCommandList]
    def commands_get_queued_commands_by_workflow(opts = {})
      data, _status_code, _headers = commands_get_queued_commands_by_workflow_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :search The search string to query records
    # @return [Array<(QueuedCommandList, Integer, Hash)>] QueuedCommandList data, response status code and response headers
    def commands_get_queued_commands_by_workflow_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommandsApi.commands_get_queued_commands_by_workflow ...'
      end
      # resource path
      local_var_path = '/queuedcommand/workflows'
      ...
      return_type = opts[:return_type] || 'QueuedCommandList' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommandsApi#commands_get_queued_commands_by_workflow\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
