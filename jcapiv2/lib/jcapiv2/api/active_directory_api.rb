...
module JCAPIv2
  class ActiveDirectoryApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectoryAgentListOutput, Integer, Hash)>] ActiveDirectoryAgentListOutput data, response status code and response headers
    def activedirectories_agents_get_with_http_info(activedirectory_id, agent_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ActiveDirectoryAgentListOutput' 
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<ActiveDirectoryAgentListOutput>, Integer, Hash)>] Array<ActiveDirectoryAgentListOutput> data, response status code and response headers
    def activedirectories_agents_list_with_http_info(activedirectory_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<ActiveDirectoryAgentListOutput>' 
    ...
    # @option opts [ActiveDirectoryAgentInput] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectoryAgentGetOutput, Integer, Hash)>] ActiveDirectoryAgentGetOutput data, response status code and response headers
    def activedirectories_agents_post_with_http_info(activedirectory_id, opts = {})
      ...
      return_type = opts[:return_type] || 'ActiveDirectoryAgentGetOutput' 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectoryOutput, Integer, Hash)>] ActiveDirectoryOutput data, response status code and response headers
    def activedirectories_delete_with_http_info(id, opts = {})
      ...
      return_type = opts[:return_type] || 'ActiveDirectoryOutput' 
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<ActiveDirectoryOutput>, Integer, Hash)>] Array<ActiveDirectoryOutput> data, response status code and response headers
    def activedirectories_list_with_http_info(opts = {})
      ...
      return_type = opts[:return_type] || 'Array<ActiveDirectoryOutput>' 
