...
module JCAPIv1
  class CommandsApi
    ...
    def commands_delete_with_http_info(id, content_type, accept, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling CommandsApi.commands_delete" if id.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling CommandsApi.commands_delete" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling CommandsApi.commands_delete" if accept.nil?
      # resource path
      local_var_path = "/commands/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def commands_get_with_http_info(id, content_type, accept, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CommandsApi.commands_get" if id.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling CommandsApi.commands_get" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling CommandsApi.commands_get" if accept.nil?
      # resource path
      local_var_path = "/commands/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def commands_list_with_http_info(content_type, accept, opts = {})
      ...
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling CommandsApi.commands_list" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling CommandsApi.commands_list" if accept.nil?
      # resource path
      local_var_path = "/commands/".sub('{format}','json')
    ...
    def commands_post_with_http_info(content_type, accept, opts = {})
      ...
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling CommandsApi.commands_post" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling CommandsApi.commands_post" if accept.nil?
      # resource path
      local_var_path = "/commands/".sub('{format}','json')
    ...
    def commands_put_with_http_info(id, content_type, accept, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling CommandsApi.commands_put" if id.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling CommandsApi.commands_put" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling CommandsApi.commands_put" if accept.nil?
      # resource path
      local_var_path = "/commands/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
