...
describe 'SystemusersApi' do
  ...
  # unit tests for systemusers_expire
  ...
  # @option opts [String] :x_org_id 
  # @return [String]
  describe 'systemusers_expire test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for systemusers_mfasync
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'systemusers_mfasync test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for systemusers_state_activate
  ...
  # @return [String]
  describe 'systemusers_state_activate test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for systemusers_totp_info
  ...
  describe 'systemusers_totp_info test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
