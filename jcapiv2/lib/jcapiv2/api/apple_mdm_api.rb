...
module JCAPIv2
  class AppleMDMApi
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [nil]
    def applemdms_devices_os_update_status(apple_mdm_id, device_id, opts = {})
      applemdms_devices_os_update_status_with_http_info(apple_mdm_id, device_id, opts)
      nil
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def applemdms_devices_os_update_status_with_http_info(apple_mdm_id, device_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AppleMDMApi.applemdms_devices_os_update_status ...'
      end
      # verify the required parameter 'apple_mdm_id' is set
      if @api_client.config.client_side_validation && apple_mdm_id.nil?
        fail ArgumentError, "Missing the required parameter 'apple_mdm_id' when calling AppleMDMApi.applemdms_devices_os_update_status"
      end
      # verify the required parameter 'device_id' is set
      if @api_client.config.client_side_validation && device_id.nil?
        fail ArgumentError, "Missing the required parameter 'device_id' when calling AppleMDMApi.applemdms_devices_os_update_status"
      end
      # resource path
      local_var_path = '/applemdms/{apple_mdm_id}/devices/{device_id}/osUpdateStatus'.sub('{' + 'apple_mdm_id' + '}', apple_mdm_id.to_s).sub('{' + 'device_id' + '}', device_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AppleMDMApi#applemdms_devices_os_update_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param device_id 
    # @param [Hash] opts the optional parameters
    # @option opts [ScheduleOSUpdate] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [nil]
    def applemdms_devices_schedule_os_update(apple_mdm_id, device_id, opts = {})
      applemdms_devices_schedule_os_update_with_http_info(apple_mdm_id, device_id, opts)
      nil
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def applemdms_devices_schedule_os_update_with_http_info(apple_mdm_id, device_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AppleMDMApi.applemdms_devices_schedule_os_update ...'
      end
      # verify the required parameter 'apple_mdm_id' is set
      if @api_client.config.client_side_validation && apple_mdm_id.nil?
        fail ArgumentError, "Missing the required parameter 'apple_mdm_id' when calling AppleMDMApi.applemdms_devices_schedule_os_update"
      end
      # verify the required parameter 'device_id' is set
      if @api_client.config.client_side_validation && device_id.nil?
        fail ArgumentError, "Missing the required parameter 'device_id' when calling AppleMDMApi.applemdms_devices_schedule_os_update"
      end
      # resource path
      local_var_path = '/applemdms/{apple_mdm_id}/devices/{device_id}/scheduleOSUpdate'.sub('{' + 'apple_mdm_id' + '}', apple_mdm_id.to_s).sub('{' + 'device_id' + '}', device_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AppleMDMApi#applemdms_devices_schedule_os_update\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Erase Device
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @option opts [Integer] :limit  (default to 1)
    # @option opts [Integer] :skip The offset into the records to return. (default to 0)
    # @option opts [Array<String>] :filter A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
    # @return [Array<AppleMDM>]
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @option opts [AppleMdmPatch] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [AppleMDM]
