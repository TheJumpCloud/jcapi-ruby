...
describe 'UserGroupsApi' do
  ...
  # unit tests for groups_suggestions_get
  ...
  describe 'groups_suggestions_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for groups_suggestions_post
  # List Suggestions for a User Group
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [Object]
  describe 'groups_suggestions_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
