  ...
  class GSuiteImportApi
    ...
    def gsuites_list_import_jumpcloud_users_with_http_info(gsuite_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GSuiteImportApi.gsuites_list_import_jumpcloud_users ...'
      end
      # verify the required parameter 'gsuite_id' is set
      if @api_client.config.client_side_validation && gsuite_id.nil?
        fail ArgumentError, "Missing the required parameter 'gsuite_id' when calling GSuiteImportApi.gsuites_list_import_jumpcloud_users"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GSuiteImportApi#gsuites_list_import_jumpcloud_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def gsuites_list_import_users_with_http_info(gsuite_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GSuiteImportApi.gsuites_list_import_users ...'
      end
      # verify the required parameter 'gsuite_id' is set
      if @api_client.config.client_side_validation && gsuite_id.nil?
        fail ArgumentError, "Missing the required parameter 'gsuite_id' when calling GSuiteImportApi.gsuites_list_import_users"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GSuiteImportApi#gsuites_list_import_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
