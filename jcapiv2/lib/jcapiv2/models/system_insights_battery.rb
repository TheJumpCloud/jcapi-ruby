  ...
  class SystemInsightsBattery
    ...
    def self.openapi_types
      {
        ...
        :'cycle_count' => :'Object',
        :'designed_capacity' => :'Object',
        :'health' => :'Object',
        :'manufacture_date' => :'Object',
        :'manufacturer' => :'Object',
        :'max_capacity' => :'Object',
        :'minutes_to_full_charge' => :'Object',
        :'minutes_until_empty' => :'Object',
        :'model' => :'Object',
        :'percent_remaining' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::SystemInsightsBattery` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::SystemInsightsBattery`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'amperage')
        self.amperage = attributes[:'amperage']
      end
      ...
      if attributes.key?(:'cycle_count')
        self.cycle_count = attributes[:'cycle_count']
      end

      if attributes.key?(:'designed_capacity')
      ...
      if attributes.key?(:'manufacture_date')
      ...
      if attributes.key?(:'minutes_to_full_charge')
        self.minutes_to_full_charge = attributes[:'minutes_to_full_charge']
      end

      if attributes.key?(:'minutes_until_empty')
      ...
      if attributes.key?(:'percent_remaining')
    ...
    def hash
      [amperage, charged, charging, collection_time, condition, current_capacity, cycle_count, designed_capacity, health, manufacture_date, manufacturer, max_capacity, minutes_to_full_charge, minutes_until_empty, model, percent_remaining, serial_number, state, system_id, voltage].hash
    end
