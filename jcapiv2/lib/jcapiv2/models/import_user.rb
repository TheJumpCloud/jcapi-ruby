...
module JCAPIv2
  class ImportUser
    ...
    def hash
      [addresses, company, cost_center, department, displayname, email, employee_identifier, employee_type, firstname, id, job_title, lastname, location, manager, middlename, phone_numbers, username].hash
    end
