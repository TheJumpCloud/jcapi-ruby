...
# Unit tests for SwaggerClient::ActiveDirectoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ActiveDirectoryApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ActiveDirectoryApi.new
  end
  ...
  describe 'test an instance of ActiveDirectoryApi' do
    it 'should create an instact of ActiveDirectoryApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ActiveDirectoryApi)
    end
  end
