...
module JCAPIv1
  class Systemuserreturn
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'password_date')
        self.password_date = attributes[:'password_date']
      end
