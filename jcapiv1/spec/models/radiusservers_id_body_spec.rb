...
# Unit tests for JCAPIv1::RadiusserversIdBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RadiusserversIdBody' do
  before do
    # run before each test
    @instance = JCAPIv1::RadiusserversIdBody.new
  end
  ...
  describe 'test an instance of RadiusserversIdBody' do
    it 'should create an instance of RadiusserversIdBody' do
      expect(@instance).to be_instance_of(JCAPIv1::RadiusserversIdBody)
    end
  end
