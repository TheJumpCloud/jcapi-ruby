  ...
  class SystemInsightsLaunchd
    ...
    def self.openapi_types
      {
        ...
        :'queue_directories' => :'Object',
        :'root_directory' => :'Object',
        :'run_at_load' => :'Object',
        :'start_interval' => :'Object',
        :'start_on_mount' => :'Object',
        :'stderr_path' => :'Object',
        :'stdout_path' => :'Object',
        :'system_id' => :'Object',
        :'username' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::SystemInsightsLaunchd` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::SystemInsightsLaunchd`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inetd_compatibility')
      ...
      if attributes.key?(:'program_arguments')
        self.program_arguments = attributes[:'program_arguments']
      end

      if attributes.key?(:'queue_directories')
      ...
      if attributes.key?(:'start_on_mount')
        self.start_on_mount = attributes[:'start_on_mount']
      end

      if attributes.key?(:'stderr_path')
        self.stderr_path = attributes[:'stderr_path']
      end

      if attributes.key?(:'stdout_path')
