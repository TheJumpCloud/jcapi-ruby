...
module JCAPIv2
  class UserGroupsApi
    ...
    def groups_user_suggestions_get(group_id, opts = {})
      data, _status_code, _headers = groups_user_suggestions_get_with_http_info(group_id, opts)
      data
    end
    ...
    def groups_user_suggestions_get_with_http_info(group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserGroupsApi.groups_user_suggestions_get ...'
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling UserGroupsApi.groups_user_suggestions_get"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserGroupsApi#groups_user_suggestions_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def groups_user_suggestions_post(body, group_id, opts = {})
      data, _status_code, _headers = groups_user_suggestions_post_with_http_info(body, group_id, opts)
      data
    end
    ...
    def groups_user_suggestions_post_with_http_info(body, group_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserGroupsApi.groups_user_suggestions_post ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling UserGroupsApi.groups_user_suggestions_post"
      end
      # verify the required parameter 'group_id' is set
      if @api_client.config.client_side_validation && group_id.nil?
        fail ArgumentError, "Missing the required parameter 'group_id' when calling UserGroupsApi.groups_user_suggestions_post"
      end
      # resource path
      local_var_path = '/usergroups/{group_id}/suggestions'.sub('{' + 'group_id' + '}', group_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserGroupsApi#groups_user_suggestions_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
