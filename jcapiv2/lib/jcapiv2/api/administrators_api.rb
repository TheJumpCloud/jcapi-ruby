  ...
  class AdministratorsApi
    ...
    def administrator_organizations_create_by_administrator_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdministratorsApi.administrator_organizations_create_by_administrator ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AdministratorsApi.administrator_organizations_create_by_administrator"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdministratorsApi#administrator_organizations_create_by_administrator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def administrator_organizations_list_by_administrator_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdministratorsApi.administrator_organizations_list_by_administrator ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AdministratorsApi.administrator_organizations_list_by_administrator"
      end
      # resource path
      local_var_path = '/administrators/{id}/organizationlinks'.sub('{' + 'id' + '}', id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdministratorsApi#administrator_organizations_list_by_administrator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def administrator_organizations_list_by_organization_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdministratorsApi.administrator_organizations_list_by_organization ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AdministratorsApi.administrator_organizations_list_by_organization"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdministratorsApi#administrator_organizations_list_by_organization\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def administrator_organizations_remove_by_administrator_with_http_info(administrator_id, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AdministratorsApi.administrator_organizations_remove_by_administrator ...'
      end
      # verify the required parameter 'administrator_id' is set
      if @api_client.config.client_side_validation && administrator_id.nil?
        fail ArgumentError, "Missing the required parameter 'administrator_id' when calling AdministratorsApi.administrator_organizations_remove_by_administrator"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AdministratorsApi.administrator_organizations_remove_by_administrator"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AdministratorsApi#administrator_organizations_remove_by_administrator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
