...
# Unit tests for JCAPIv2::ManagedServiceProviderApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManagedServiceProviderApi' do
  before do
    # run before each test
    @instance = JCAPIv2::ManagedServiceProviderApi.new
  end
  ...
  describe 'test an instance of ManagedServiceProviderApi' do
    it 'should create an instance of ManagedServiceProviderApi' do
      expect(@instance).to be_instance_of(JCAPIv2::ManagedServiceProviderApi)
    end
  end

  # unit tests for administrator_organizations_create_by_administrator
  ...
  describe 'administrator_organizations_create_by_administrator test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for administrator_organizations_list_by_administrator
  ...
  describe 'administrator_organizations_list_by_administrator test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for administrator_organizations_list_by_organization
  ...
  # @option opts [Integer] :skip The offset into the records to return.
  # @return [Array<AdministratorOrganizationLink>]
  describe 'administrator_organizations_list_by_organization test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for administrator_organizations_remove_by_administrator
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'administrator_organizations_remove_by_administrator test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
