  ...
  class SystemInsightsSystemInfo
    ...
    def self.openapi_types
      {
        ...
        :'cpu_brand' => :'Object',
        :'cpu_logical_cores' => :'Object',
        :'cpu_microcode' => :'Object',
        :'cpu_physical_cores' => :'Object',
        :'cpu_subtype' => :'Object',
        :'cpu_type' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::SystemInsightsSystemInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::SystemInsightsSystemInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cpu_brand')
        self.cpu_brand = attributes[:'cpu_brand']
      end

      if attributes.key?(:'cpu_logical_cores')
        self.cpu_logical_cores = attributes[:'cpu_logical_cores']
      end

      if attributes.key?(:'cpu_microcode')
      ...
      if attributes.key?(:'hardware_model')
        self.hardware_model = attributes[:'hardware_model']
      end

      if attributes.key?(:'hardware_serial')
        self.hardware_serial = attributes[:'hardware_serial']
      end

      if attributes.key?(:'hardware_vendor')
      ...
      if attributes.key?(:'local_hostname')
        self.local_hostname = attributes[:'local_hostname']
      end

      if attributes.key?(:'physical_memory')
