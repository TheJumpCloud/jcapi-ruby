...
module JCAPIv2
  class ImportUsersRequest
    ...
    attr_accessor :allow_user_reactivation
    ...
    def self.attribute_map
      {
        :'allow_user_reactivation' => :'allowUserReactivation',
    ...
    def self.openapi_types
      {
        :'allow_user_reactivation' => :'Object',
        :'operations' => :'Object',
        :'query_string' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::ImportUsersRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::ImportUsersRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allow_user_reactivation')
        self.allow_user_reactivation = attributes[:'allow_user_reactivation']
      else
        self.allow_user_reactivation = true
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_user_reactivation == o.allow_user_reactivation &&
    ...
    def hash
      [allow_user_reactivation, operations, query_string].hash
    end
