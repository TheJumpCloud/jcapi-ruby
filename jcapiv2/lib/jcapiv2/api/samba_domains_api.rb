...
module JCAPIv2
  class SambaDomainsApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(SambaDomain, Integer, Hash)>] SambaDomain data, response status code and response headers
    def ldapservers_samba_domains_get_with_http_info(ldapserver_id, id, opts = {})
      ...
      return_type = opts[:return_type] || 'SambaDomain' 
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<SambaDomain>, Integer, Hash)>] Array<SambaDomain> data, response status code and response headers
    def ldapservers_samba_domains_list_with_http_info(ldapserver_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<SambaDomain>' 
