...
module JCAPIv2
  class Office365Api
    ...
    # @param office365_id Id for the specific M365/Azure AD directory sync integration instance.
    # @param domain_id ObjectID of the domain to be deleted.
    # @param [Hash] opts the optional parameters
    # @return [O365DomainResponse]
    def domains_delete(office365_id, domain_id, opts = {})
      data, _status_code, _headers = domains_delete_with_http_info(office365_id, domain_id, opts)
      data
    end
    ...
    # @param domain_id ObjectID of the domain to be deleted.
    # @param [Hash] opts the optional parameters
    # @return [Array<(O365DomainResponse, Integer, Hash)>] O365DomainResponse data, response status code and response headers
    def domains_delete_with_http_info(office365_id, domain_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Office365Api.domains_delete ...'
      end
      # verify the required parameter 'office365_id' is set
      if @api_client.config.client_side_validation && office365_id.nil?
        fail ArgumentError, "Missing the required parameter 'office365_id' when calling Office365Api.domains_delete"
      end
      # verify the required parameter 'domain_id' is set
      if @api_client.config.client_side_validation && domain_id.nil?
        fail ArgumentError, "Missing the required parameter 'domain_id' when calling Office365Api.domains_delete"
      end
      # resource path
      local_var_path = '/office365s/{office365_id}/domains/{domain_id}'.sub('{' + 'office365_id' + '}', office365_id.to_s).sub('{' + 'domain_id' + '}', domain_id.to_s)
      ...
      return_type = opts[:return_type] || 'O365DomainResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Office365Api#domains_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [O365DomainResponse]
    def domains_insert(body, office365_id, opts = {})
      data, _status_code, _headers = domains_insert_with_http_info(body, office365_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(O365DomainResponse, Integer, Hash)>] O365DomainResponse data, response status code and response headers
    def domains_insert_with_http_info(body, office365_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Office365Api.domains_insert ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling Office365Api.domains_insert"
      end
      # verify the required parameter 'office365_id' is set
      if @api_client.config.client_side_validation && office365_id.nil?
        fail ArgumentError, "Missing the required parameter 'office365_id' when calling Office365Api.domains_insert"
      end
      # resource path
      local_var_path = '/office365s/{office365_id}/domains'.sub('{' + 'office365_id' + '}', office365_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Office365Api#domains_insert\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def domains_list(office365_id, opts = {})
      data, _status_code, _headers = domains_list_with_http_info(office365_id, opts)
      data
    end
    ...
    # @return [Array<(O365DomainsListResponse, Integer, Hash)>] O365DomainsListResponse data, response status code and response headers
    def domains_list_with_http_info(office365_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Office365Api.domains_list ...'
      end
      # verify the required parameter 'office365_id' is set
      if @api_client.config.client_side_validation && office365_id.nil?
        fail ArgumentError, "Missing the required parameter 'office365_id' when calling Office365Api.domains_list"
      end
      # resource path
      local_var_path = '/office365s/{office365_id}/domains'.sub('{' + 'office365_id' + '}', office365_id.to_s)
      ...
      return_type = opts[:return_type] || 'O365DomainsListResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Office365Api#domains_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Office365]
    def office365s_get(office365_id, opts = {})
      data, _status_code, _headers = office365s_get_with_http_info(office365_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Office365, Integer, Hash)>] Office365 data, response status code and response headers
    def office365s_get_with_http_info(office365_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Office365Api.office365s_get ...'
      end
      # verify the required parameter 'office365_id' is set
      if @api_client.config.client_side_validation && office365_id.nil?
        fail ArgumentError, "Missing the required parameter 'office365_id' when calling Office365Api.office365s_get"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'Office365' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Office365Api#office365s_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param office365_id 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :consistency_level Defines the consistency header for O365 requests. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#request-headers
    # @option opts [Integer] :top Office 365 API maximum number of results per page. See https://docs.microsoft.com/en-us/graph/paging.
    # @option opts [String] :skip_token Office 365 API token used to access the next page of results. See https://docs.microsoft.com/en-us/graph/paging.
    # @option opts [String] :filter Office 365 API filter parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
    # @option opts [String] :search Office 365 API search parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
    # @option opts [String] :orderby Office 365 API orderby parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
    # @option opts [BOOLEAN] :count Office 365 API count parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
    # @return [InlineResponse20012]
    def office365s_list_import_users(office365_id, opts = {})
      data, _status_code, _headers = office365s_list_import_users_with_http_info(office365_id, opts)
      data
    end
    ...
    def office365s_list_import_users_with_http_info(office365_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Office365Api.office365s_list_import_users ...'
      end
      # verify the required parameter 'office365_id' is set
      if @api_client.config.client_side_validation && office365_id.nil?
        fail ArgumentError, "Missing the required parameter 'office365_id' when calling Office365Api.office365s_list_import_users"
      end
      # resource path
      local_var_path = '/office365s/{office365_id}/import/users'.sub('{' + 'office365_id' + '}', office365_id.to_s)

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'top'] = opts[:'top'] if !opts[:'top'].nil?
      query_params[:'skipToken'] = opts[:'skip_token'] if !opts[:'skip_token'].nil?
      ...
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['application/json'])
      header_params[:'ConsistencyLevel'] = opts[:'consistency_level'] if !opts[:'consistency_level'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Office365Api#office365s_list_import_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param office365_id ObjectID of the Office 365 instance.
    # @param [Hash] opts the optional parameters
    # @option opts [Office365] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Office365]
    def office365s_patch(office365_id, opts = {})
      data, _status_code, _headers = office365s_patch_with_http_info(office365_id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Office365, Integer, Hash)>] Office365 data, response status code and response headers
    def office365s_patch_with_http_info(office365_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Office365Api.office365s_patch ...'
      end
      # verify the required parameter 'office365_id' is set
      if @api_client.config.client_side_validation && office365_id.nil?
        fail ArgumentError, "Missing the required parameter 'office365_id' when calling Office365Api.office365s_patch"
      end
      # resource path
      local_var_path = '/office365s/{office365_id}'.sub('{' + 'office365_id' + '}', office365_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Office365Api#office365s_patch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def translation_rules_office365_delete(office365_id, id, opts = {})
      translation_rules_office365_delete_with_http_info(office365_id, id, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def translation_rules_office365_delete_with_http_info(office365_id, id, opts = {})
      if @api_client.config.debugging
    ...
    def translation_rules_office365_get(office365_id, id, opts = {})
      data, _status_code, _headers = translation_rules_office365_get_with_http_info(office365_id, id, opts)
      data
    end
    ...
    # @param id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Office365TranslationRule, Integer, Hash)>] Office365TranslationRule data, response status code and response headers
    def translation_rules_office365_get_with_http_info(office365_id, id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'Office365TranslationRule' 
    ...
    def translation_rules_office365_list(office365_id, opts = {})
      data, _status_code, _headers = translation_rules_office365_list_with_http_info(office365_id, opts)
      data
    end
    ...
    # @option opts [Integer] :skip The offset into the records to return.
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @return [Array<(Array<Office365TranslationRule>, Integer, Hash)>] Array<Office365TranslationRule> data, response status code and response headers
    def translation_rules_office365_list_with_http_info(office365_id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'Array<Office365TranslationRule>' 
    ...
    # @return [Office365TranslationRule]
    def translation_rules_office365_post(office365_id, opts = {})
      data, _status_code, _headers = translation_rules_office365_post_with_http_info(office365_id, opts)
      data
    end
    ...
    # @option opts [Office365TranslationRuleRequest] :body 
    # @return [Array<(Office365TranslationRule, Integer, Hash)>] Office365TranslationRule data, response status code and response headers
    def translation_rules_office365_post_with_http_info(office365_id, opts = {})
      if @api_client.config.debugging
