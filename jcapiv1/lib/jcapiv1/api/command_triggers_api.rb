...
module JCAPIv1
  class CommandTriggersApi
    ...
    def command_trigger_webhook_post(triggername, opts = {})
      data, _status_code, _headers = command_trigger_webhook_post_with_http_info(triggername, opts)
      data
    end
    ...
    # @option opts [Object] :body 
    # @option opts [String] :x_org_id 
    # @return [Array<(Triggerreturn, Integer, Hash)>] Triggerreturn data, response status code and response headers
    def command_trigger_webhook_post_with_http_info(triggername, opts = {})
      ...
      return_type = opts[:return_type] || 'Triggerreturn' 
