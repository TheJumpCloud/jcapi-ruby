...
```shell
gem install ./jcapiv2-1.0.2.gem
```
(for development, run `gem install --dev ./jcapiv2-1.0.2.gem` to install the development dependencies)
...
## Documentation for Models
 ...
 - [JCAPIv2::WorkdayWorkerImport](docs/WorkdayWorkerImport.md)
