...
# Unit tests for JCAPIv2::AdministratorsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdministratorsApi' do
  before do
    # run before each test
    @instance = JCAPIv2::AdministratorsApi.new
  end
  ...
  describe 'test an instance of AdministratorsApi' do
    it 'should create an instance of AdministratorsApi' do
      expect(@instance).to be_instance_of(JCAPIv2::AdministratorsApi)
    end
  end
