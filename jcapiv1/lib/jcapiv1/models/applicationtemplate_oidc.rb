...
module JCAPIv1
  class ApplicationtemplateOidc
    ...
    def valid?
      token_endpoint_auth_method_validator = EnumAttributeValidator.new('Object', ['none', 'client_secret_post'])
    ...
    def token_endpoint_auth_method=(token_endpoint_auth_method)
      validator = EnumAttributeValidator.new('Object', ['none', 'client_secret_post'])
