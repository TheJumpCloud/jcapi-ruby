...
# Unit tests for SwaggerClient::RadiusServersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RadiusServersApi' do
  before do
    # run before each test
    @instance = SwaggerClient::RadiusServersApi.new
  end
  ...
  describe 'test an instance of RadiusServersApi' do
    it 'should create an instact of RadiusServersApi' do
      expect(@instance).to be_instance_of(SwaggerClient::RadiusServersApi)
    end
  end
