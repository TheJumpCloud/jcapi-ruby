...
module JCAPIv1
  class RadiusserversIdBody
    ...
    def hash
      [device_cert_enabled, mfa, name, network_source_ip, shared_secret, tags, user_cert_enabled, user_lockout_action, user_password_enabled, user_password_expiration_action].hash
    end
