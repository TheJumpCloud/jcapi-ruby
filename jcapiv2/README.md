...
```shell
gem install ./jcapiv2-5.0.0.gem
```
(for development, run `gem install --dev ./jcapiv2-5.0.0.gem` to install the development dependencies)
...
api_instance = JCAPIv2::BulkJobRequestsApi.new
users = ['users_example'] # Array<String> | A list of system user IDs
opts = { 
  limit: 10, # Integer | The number of records to return at once. Limited to 100.
  skip: 0 # Integer | The offset into the records to return.
}
...
begin
  #List Suggestions for a User Group
  result = api_instance.groups_suggestions_post(body, group_id, opts)
  p result
rescue JCAPIv2::ApiError => e
...
*JCAPIv2::ApplicationsApi* | [**applications_post_logo**](docs/ApplicationsApi.md#applications_post_logo) | **POST** /applications/{application_id}/logo | 
...
*JCAPIv2::BulkJobRequestsApi* | [**bulk_user_states_get_next_scheduled**](docs/BulkJobRequestsApi.md#bulk_user_states_get_next_scheduled) | **GET** /bulk/userstates/eventlist/next | Gets the next scheduled state change for each user in a list of system users
...
*JCAPIv2::OrganizationsApi* | [**organizations_list_cases**](docs/OrganizationsApi.md#organizations_list_cases) | **GET** /organizations/cases | Get all cases (Support/Feature requests) for organization
...
*JCAPIv2::UserGroupsApi* | [**groups_suggestions_get**](docs/UserGroupsApi.md#groups_suggestions_get) | **GET** /usergroups/{group_id}/suggestions | List Suggestions for a User Group
*JCAPIv2::UserGroupsApi* | [**groups_suggestions_post**](docs/UserGroupsApi.md#groups_suggestions_post) | **POST** /usergroups/{group_id}/suggestions | List Suggestions for a User Group
...
## Documentation for Models
 ...
 - [JCAPIv2::AuthnPolicyInput](docs/AuthnPolicyInput.md)
 ...
 - [JCAPIv2::InlineResponse20011Users](docs/InlineResponse20011Users.md)
 ...
 - [JCAPIv2::OrganizationCase](docs/OrganizationCase.md)
 - [JCAPIv2::OrganizationCasesResponse](docs/OrganizationCasesResponse.md)
 ...
 - [JCAPIv2::PwmAllUsersGroups](docs/PwmAllUsersGroups.md)
 - [JCAPIv2::PwmAllUsersResults](docs/PwmAllUsersResults.md)
 ...
 - [JCAPIv2::SharedFoldersListResults](docs/SharedFoldersListResults.md)
