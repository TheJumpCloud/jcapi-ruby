...
module SwaggerClient
  class RadiusServersApi
    ...
    def radius_servers_list_with_http_info(content_type, accept, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'content_type' when calling RadiusServersApi.radius_servers_list" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling RadiusServersApi.radius_servers_list" if accept.nil?
      # resource path
      local_var_path = "/radiusservers".sub('{format}','json')
    ...
    def radius_servers_put_with_http_info(content_type, accept, opts = {})
      ...
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling RadiusServersApi.radius_servers_put" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling RadiusServersApi.radius_servers_put" if accept.nil?
      # resource path
      local_var_path = "/radiusservers:id".sub('{format}','json')
