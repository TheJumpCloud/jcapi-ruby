...
describe 'SystemGroupsApi' do
  ...
  # unit tests for groups_system_suggestions_get
  ...
  describe 'groups_system_suggestions_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for groups_system_suggestions_post
  ...
  describe 'groups_system_suggestions_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
