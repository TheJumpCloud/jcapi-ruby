...
# Unit tests for JCAPIv1::ApplicationConfigSignAssertion
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApplicationConfigSignAssertion' do
  before do
    # run before each test
    @instance = JCAPIv1::ApplicationConfigSignAssertion.new
  end
  ...
  describe 'test an instance of ApplicationConfigSignAssertion' do
    it 'should create an instance of ApplicationConfigSignAssertion' do
      expect(@instance).to be_instance_of(JCAPIv1::ApplicationConfigSignAssertion)
    end
  end
