  ...
  class Command
    ...
    def self.openapi_types
      {
        ...
        :'organization' => :'Object',
        :'schedule' => :'Object',
        :'schedule_repeat_type' => :'Object',
        :'schedule_year' => :'Object',
        :'shell' => :'Object',
        :'sudo' => :'Object',
        :'systems' => :'Object',
        :'template' => :'Object',
        :'time_to_live_seconds' => :'Object',
        :'timeout' => :'Object',
        :'trigger' => :'Object',
        :'user' => :'Object'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv1::Command` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv1::Command`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'command_runners')
        if (value = attributes[:'command_runners']).is_a?(Array)
      ...
      if attributes.key?(:'listens_to')
        self.listens_to = attributes[:'listens_to']
      end
      ...
      if attributes.key?(:'schedule_repeat_type')
        self.schedule_repeat_type = attributes[:'schedule_repeat_type']
      end

      if attributes.key?(:'schedule_year')
        self.schedule_year = attributes[:'schedule_year']
      end
    ...
    def list_invalid_properties
      ...
      if @command_type.nil?
        invalid_properties.push('invalid value for "command_type", command_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @command_type.nil?
    ...
    def hash
      [command, command_runners, command_type, files, launch_type, listens_to, name, organization, schedule, schedule_repeat_type, schedule_year, shell, sudo, systems, template, time_to_live_seconds, timeout, trigger, user].hash
    end
