...
# Unit tests for SwaggerClient::SystemGroupGraphManagementReq
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SystemGroupGraphManagementReq' do
  before do
    # run before each test
    @instance = SwaggerClient::SystemGroupGraphManagementReq.new
  end
  ...
  describe 'test an instance of SystemGroupGraphManagementReq' do
    it 'should create an instact of SystemGroupGraphManagementReq' do
      expect(@instance).to be_instance_of(SwaggerClient::SystemGroupGraphManagementReq)
    end
  end
