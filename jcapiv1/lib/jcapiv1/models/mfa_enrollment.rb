...
module JCAPIv1
  class MfaEnrollment
    ...
    attr_accessor :totp_status

    attr_accessor :web_authn_status
    ...
    def self.attribute_map
      {
        ...
        :'web_authn_status' => :'webAuthnStatus'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv1::MfaEnrollment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv1::MfaEnrollment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'totp_status')
        self.totp_status = attributes[:'totp_status']
      end

      if attributes.key?(:'web_authn_status')
        self.web_authn_status = attributes[:'web_authn_status']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          totp_status == o.totp_status &&
          web_authn_status == o.web_authn_status
    end
    ...
    def hash
      [overall_status, push_status, totp_status, web_authn_status].hash
    end
