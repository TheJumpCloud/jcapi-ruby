...
# Unit tests for JCAPIv2::GoogleEMMApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleEMMApi' do
  before do
    # run before each test
    @instance = JCAPIv2::GoogleEMMApi.new
  end
  ...
  describe 'test an instance of GoogleEMMApi' do
    it 'should create an instance of GoogleEMMApi' do
      expect(@instance).to be_instance_of(JCAPIv2::GoogleEMMApi)
    end
  end

  # unit tests for devices_erase_device
  ...
  describe 'devices_erase_device test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for devices_get_device
  # Get device
  ...
  describe 'devices_get_device test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for devices_get_device_android_policy
  ...
  describe 'devices_get_device_android_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for devices_list_devices
  # List devices
  ...
  describe 'devices_list_devices test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for devices_lock_device
  # Lock device
  ...
  # @param [Hash] opts the optional parameters
  # @return [JumpcloudGoogleEmmCommandResponse]
  describe 'devices_lock_device test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for devices_reboot_device
  # Reboot device
  ...
  # @param [Hash] opts the optional parameters
  # @return [JumpcloudGoogleEmmCommandResponse]
  describe 'devices_reboot_device test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for devices_reset_password
  ...
  # @param [Hash] opts the optional parameters
  # @return [JumpcloudGoogleEmmCommandResponse]
  describe 'devices_reset_password test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for enrollment_tokens_create_enrollment_token
  ...
  describe 'enrollment_tokens_create_enrollment_token test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for enterprises_create_enterprise
  ...
  describe 'enterprises_create_enterprise test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for enterprises_delete_enterprise
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'enterprises_delete_enterprise test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for enterprises_get_connection_status
  ...
  describe 'enterprises_get_connection_status test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for enterprises_list_enterprises
  ...
  describe 'enterprises_list_enterprises test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for enterprises_patch_enterprise
  ...
  # @param [Hash] opts the optional parameters
  # @return [JumpcloudGoogleEmmEnterprise]
  describe 'enterprises_patch_enterprise test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for signup_urls_create
  ...
  describe 'signup_urls_create test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for web_tokens_create_web_token
  ...
  describe 'web_tokens_create_web_token test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
