...
# Unit tests for JCAPIv2::AuthenticationPoliciesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthenticationPoliciesApi' do
  before do
    # run before each test
    @instance = JCAPIv2::AuthenticationPoliciesApi.new
  end
  ...
  describe 'test an instance of AuthenticationPoliciesApi' do
    it 'should create an instance of AuthenticationPoliciesApi' do
      expect(@instance).to be_instance_of(JCAPIv2::AuthenticationPoliciesApi)
    end
  end

  # unit tests for authnpolicies_delete
  ...
  # @return [AuthnPolicy]
  describe 'authnpolicies_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for authnpolicies_get
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [AuthnPolicy]
  describe 'authnpolicies_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for authnpolicies_list
  ...
  describe 'authnpolicies_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for authnpolicies_patch
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [AuthnPolicy]
  describe 'authnpolicies_patch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for authnpolicies_post
  ...
  # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
  # @return [AuthnPolicy]
  describe 'authnpolicies_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
