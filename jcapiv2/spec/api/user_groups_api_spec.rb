...
# Unit tests for SwaggerClient::UserGroupsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserGroupsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UserGroupsApi.new
  end
  ...
  describe 'test an instance of UserGroupsApi' do
    it 'should create an instact of UserGroupsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::UserGroupsApi)
    end
  end
