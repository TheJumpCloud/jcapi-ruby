...
module JCAPIv2
  class ActiveDirectoryApi
    ...
    # @return [nil]
    def activedirectories_agents_delete(activedirectory_id, agent_id, opts = {})
      activedirectories_agents_delete_with_http_info(activedirectory_id, agent_id, opts)
      nil
    end
    ...
    def activedirectories_agents_delete_with_http_info(activedirectory_id, agent_id, opts = {})
    ...
    def activedirectories_agents_get(activedirectory_id, agent_id, opts = {})
      data, _status_code, _headers = activedirectories_agents_get_with_http_info(activedirectory_id, agent_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectoryAgentList, Integer, Hash)>] ActiveDirectoryAgentList data, response status code and response headers
    def activedirectories_agents_get_with_http_info(activedirectory_id, agent_id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'ActiveDirectoryAgentList' 
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<ActiveDirectoryAgentList>]
    def activedirectories_agents_list(activedirectory_id, opts = {})
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<ActiveDirectoryAgentList>, Integer, Hash)>] Array<ActiveDirectoryAgentList> data, response status code and response headers
    def activedirectories_agents_list_with_http_info(activedirectory_id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'Array<ActiveDirectoryAgentList>' 
    ...
    # @param activedirectory_id 
    # @param [Hash] opts the optional parameters
    # @option opts [ActiveDirectoryAgent] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [ActiveDirectoryAgentGet]
    def activedirectories_agents_post(activedirectory_id, opts = {})
    ...
    # @option opts [ActiveDirectoryAgent] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectoryAgentGet, Integer, Hash)>] ActiveDirectoryAgentGet data, response status code and response headers
    def activedirectories_agents_post_with_http_info(activedirectory_id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'ActiveDirectoryAgentGet' 
    ...
    def activedirectories_delete(id, opts = {})
      data, _status_code, _headers = activedirectories_delete_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectory, Integer, Hash)>] ActiveDirectory data, response status code and response headers
    def activedirectories_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'ActiveDirectory' 
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [ActiveDirectory]
    def activedirectories_get(id, opts = {})
      data, _status_code, _headers = activedirectories_get_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectory, Integer, Hash)>] ActiveDirectory data, response status code and response headers
    def activedirectories_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    def activedirectories_list(opts = {})
      data, _status_code, _headers = activedirectories_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<String>] :sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(Array<ActiveDirectory>, Integer, Hash)>] Array<ActiveDirectory> data, response status code and response headers
    def activedirectories_list_with_http_info(opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'Array<ActiveDirectory>' 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [ActiveDirectory] :body 
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [ActiveDirectory]
    def activedirectories_post(opts = {})
      data, _status_code, _headers = activedirectories_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :x_org_id Organization identifier that can be obtained from console settings.
    # @return [Array<(ActiveDirectory, Integer, Hash)>] ActiveDirectory data, response status code and response headers
    def activedirectories_post_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    def graph_active_directory_traverse_user_with_http_info(activedirectory_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActiveDirectoryApi.graph_active_directory_traverse_user ...'
      end
      # verify the required parameter 'activedirectory_id' is set
      if @api_client.config.client_side_validation && activedirectory_id.nil?
        fail ArgumentError, "Missing the required parameter 'activedirectory_id' when calling ActiveDirectoryApi.graph_active_directory_traverse_user"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActiveDirectoryApi#graph_active_directory_traverse_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
