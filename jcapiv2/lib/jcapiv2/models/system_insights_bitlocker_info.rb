...
module JCAPIv2
  ...
  class SystemInsightsBitlockerInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'devide_id')
        self.devide_id = attributes[:'devide_id']
      end
    ...
    def hash
      [collection_time, conversion_status, devide_id, drive_letter, encryption_method, persistent_volume_id, protection_status, system_id].hash
    end
