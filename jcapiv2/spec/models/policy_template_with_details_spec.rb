...
# Unit tests for SwaggerClient::PolicyTemplateWithDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PolicyTemplateWithDetails' do
  before do
    # run before each test
    @instance = SwaggerClient::PolicyTemplateWithDetails.new
  end
  ...
  describe 'test an instance of PolicyTemplateWithDetails' do
    it 'should create an instact of PolicyTemplateWithDetails' do
      expect(@instance).to be_instance_of(SwaggerClient::PolicyTemplateWithDetails)
    end
  end
