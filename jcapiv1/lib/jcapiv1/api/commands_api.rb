...
module JCAPIv1
  class CommandsApi
    ...
    def command_file_get(id, opts = {})
      data, _status_code, _headers = command_file_get_with_http_info(id, opts)
      data
    end
    ...
    # @return [Array<(Commandfilereturn, Integer, Hash)>] Commandfilereturn data, response status code and response headers
    def command_file_get_with_http_info(id, opts = {})
      ...
      return_type = opts[:return_type] || 'Commandfilereturn' 
    ...
    # @option opts [String] :x_org_id 
    # @return [Command]
    def commands_delete(id, opts = {})
      data, _status_code, _headers = commands_delete_with_http_info(id, opts)
      data
    end
    ...
    def commands_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
      ...
      return_type = opts[:return_type] || 'Command' 
    ...
    # @option opts [String] :x_org_id 
    # @return [Command]
    def commands_get(id, opts = {})
      data, _status_code, _headers = commands_get_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(Command, Integer, Hash)>] Command data, response status code and response headers
    def commands_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    def commands_get_results(id, opts = {})
      data, _status_code, _headers = commands_get_results_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [Integer] :limit The number of records to return at once. Limited to 100.
    # @option opts [Integer] :skip The offset into the records to return.
    # @return [Array<(Array<Commandresult>, Integer, Hash)>] Array<Commandresult> data, response status code and response headers
    def commands_get_results_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommandsApi.commands_get_results ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CommandsApi.commands_get_results"
      end
      # resource path
      local_var_path = '/commands/{id}/results'.sub('{' + 'id' + '}', id.to_s)
      ...
      return_type = opts[:return_type] || 'Array<Commandresult>' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommandsApi#commands_get_results\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # List All Commands
    ...
    # @return [Commandslist]
    def commands_list(opts = {})
      data, _status_code, _headers = commands_list_with_http_info(opts)
      data
    end
    ...
    def commands_list_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :x_org_id 
    # @return [Command]
    def commands_post(opts = {})
      data, _status_code, _headers = commands_post_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(Command, Integer, Hash)>] Command data, response status code and response headers
    def commands_post_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :x_org_id 
    # @return [Command]
    def commands_put(id, opts = {})
      data, _status_code, _headers = commands_put_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :x_org_id 
    # @return [Array<(Command, Integer, Hash)>] Command data, response status code and response headers
    def commands_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [RunCommandBody] :body 
    # @return [InlineResponse200]
    def commands_run(opts = {})
      data, _status_code, _headers = commands_run_with_http_info(opts)
      data
    end
    ...
    def commands_run_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CommandsApi.commands_run ...'
      end
      # resource path
      local_var_path = '/runCommand'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CommandsApi#commands_run\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
