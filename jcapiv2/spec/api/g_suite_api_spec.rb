...
describe 'GSuiteApi' do
  ...
  # unit tests for gapps_domains_delete
  ...
  describe 'gapps_domains_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for gapps_domains_insert
  ...
  # @return [JumpcloudGappsDomainResponse]
  describe 'gapps_domains_insert test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for gapps_domains_list
  ...
  describe 'gapps_domains_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for gsuites_list_import_jumpcloud_users
  ...
  describe 'gsuites_list_import_jumpcloud_users test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for gsuites_list_import_users
  ...
  describe 'gsuites_list_import_users test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
