...
```shell
gem install ./jcapiv1-3.1.0.gem
```
(for development, run `gem install --dev ./jcapiv1-3.1.0.gem` to install the development dependencies)
...
*JCAPIv1::SupportApi* | [**case_post**](docs/SupportApi.md#case_post) | **POST** /api/cases | Create a Case
