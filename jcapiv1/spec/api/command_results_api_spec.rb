...
# Unit tests for SwaggerClient::CommandResultsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommandResultsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CommandResultsApi.new
  end
  ...
  describe 'test an instance of CommandResultsApi' do
    it 'should create an instact of CommandResultsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CommandResultsApi)
    end
  end
