...
module JCAPIv1
  class Organizationsettings
    ...
    attr_accessor :max_system_users
    ...
    def self.attribute_map
      {
        ...
        :'logo' => :'logo',
        :'max_system_users' => :'maxSystemUsers',
        :'name' => :'name',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'max_system_users')
        self.max_system_users = attributes[:'max_system_users']
      end
      ...
      if attributes.key?(:'windows_mdm')
        self.windows_mdm = attributes[:'windows_mdm']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          logo == o.logo &&
          max_system_users == o.max_system_users &&
          name == o.name &&
