  ...
  class SystemOsVersionDetail
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv1::SystemOsVersionDetail` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv1::SystemOsVersionDetail`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'distribution_name')
        self.distribution_name = attributes[:'distribution_name']
      end
      ...
      if attributes.key?(:'major_number')
      ...
      if attributes.key?(:'minor_number')
        self.minor_number = attributes[:'minor_number']
      end
      ...
      if attributes.key?(:'patch_number')
        self.patch_number = attributes[:'patch_number']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          major == o.major &&
          major_number == o.major_number &&
          minor == o.minor &&
          minor_number == o.minor_number &&
          os_name == o.os_name &&
          patch == o.patch &&
          patch_number == o.patch_number &&
    ...
    def hash
      [distribution_name, major, major_number, minor, minor_number, os_name, patch, patch_number, release_name, revision].hash
    end
