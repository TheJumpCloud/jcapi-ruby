...
describe 'SystemsApi' do
  ...
  # unit tests for systems_command_builtin_erase
  # Erase a System
  ...
  # @return [nil]
  describe 'systems_command_builtin_erase test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for systems_command_builtin_lock
  # Lock a System
  ...
  # @option opts [String] :x_org_id 
  # @return [nil]
  describe 'systems_command_builtin_lock test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for systems_command_builtin_restart
  # Restart a System
  ...
  # @option opts [String] :x_org_id 
  # @return [nil]
  describe 'systems_command_builtin_restart test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for systems_command_builtin_shutdown
  # Shutdown a System
  ...
  # @option opts [String] :x_org_id 
  # @return [nil]
  describe 'systems_command_builtin_shutdown test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
