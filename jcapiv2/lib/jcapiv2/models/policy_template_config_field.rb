...
module JCAPIv2
  class PolicyTemplateConfigField
    ...
    def valid?
      display_type_validator = EnumAttributeValidator.new('Object', ['checkbox', 'date', 'email', 'file', 'number', 'select', 'text', 'textarea', 'singlelistbox', 'doublelistbox', 'table'])
    ...
    def display_type=(display_type)
      validator = EnumAttributeValidator.new('Object', ['checkbox', 'date', 'email', 'file', 'number', 'select', 'text', 'textarea', 'singlelistbox', 'doublelistbox', 'table'])
    ...
    def hash
      [default_value, display_options, display_type, id, label, name, position, read_only, required, sensitive, tooltip].hash
    end
