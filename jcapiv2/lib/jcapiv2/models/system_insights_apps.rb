...
module JCAPIv2
  class SystemInsightsApps
    ...
    def self.openapi_types
      {
        :'applescript_enabled' => :'Object',
        :'bundle_executable' => :'Object',
        :'bundle_identifier' => :'Object',
        :'bundle_name' => :'Object',
        :'bundle_package_type' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `JCAPIv2::SystemInsightsApps` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `JCAPIv2::SystemInsightsApps`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'applescript_enabled')
        self.applescript_enabled = attributes[:'applescript_enabled']
      end

      if attributes.key?(:'bundle_executable')
      ...
      if attributes.key?(:'bundle_package_type')
        self.bundle_package_type = attributes[:'bundle_package_type']
      end

      if attributes.key?(:'bundle_short_version')
      ...
      if attributes.key?(:'development_region')
      ...
      if attributes.key?(:'info_string')
        self.info_string = attributes[:'info_string']
      end

      if attributes.key?(:'last_opened_time')
        self.last_opened_time = attributes[:'last_opened_time']
      end

      if attributes.key?(:'minimum_system_version')
