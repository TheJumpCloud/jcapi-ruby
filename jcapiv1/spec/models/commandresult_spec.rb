...
# Unit tests for SwaggerClient::Commandresult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Commandresult' do
  before do
    # run before each test
    @instance = SwaggerClient::Commandresult.new
  end
  ...
  describe 'test an instance of Commandresult' do
    it 'should create an instact of Commandresult' do
      expect(@instance).to be_instance_of(SwaggerClient::Commandresult)
    end
  end
