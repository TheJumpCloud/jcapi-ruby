...
module JCAPIv1
  class TagsApi
    ...
    def tags_delete_with_http_info(name, content_type, accept, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'name' when calling TagsApi.tags_delete" if name.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling TagsApi.tags_delete" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling TagsApi.tags_delete" if accept.nil?
      # resource path
      local_var_path = "/tags/{name}".sub('{format}','json').sub('{' + 'name' + '}', name.to_s)
    ...
    def tags_get_with_http_info(name, content_type, accept, opts = {})
      ...
      # verify the required parameter 'name' is set
      fail ArgumentError, "Missing the required parameter 'name' when calling TagsApi.tags_get" if name.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling TagsApi.tags_get" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling TagsApi.tags_get" if accept.nil?
      # resource path
      local_var_path = "/Tags/{name}".sub('{format}','json').sub('{' + 'name' + '}', name.to_s)
    ...
    def tags_list_with_http_info(content_type, accept, opts = {})
      ...
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling TagsApi.tags_list" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling TagsApi.tags_list" if accept.nil?
      # resource path
    ...
    def tags_post_with_http_info(content_type, accept, opts = {})
      ...
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling TagsApi.tags_post" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling TagsApi.tags_post" if accept.nil?
      # resource path
      local_var_path = "/tags".sub('{format}','json')
    ...
    def tags_put_with_http_info(name, content_type, accept, opts = {})
      ...
      # verify the required parameter 'name' is set
      fail ArgumentError, "Missing the required parameter 'name' when calling TagsApi.tags_put" if name.nil?
      # verify the required parameter 'content_type' is set
      fail ArgumentError, "Missing the required parameter 'content_type' when calling TagsApi.tags_put" if content_type.nil?
      # verify the required parameter 'accept' is set
      fail ArgumentError, "Missing the required parameter 'accept' when calling TagsApi.tags_put" if accept.nil?
      # resource path
      local_var_path = "/Tag/{name}".sub('{format}','json').sub('{' + 'name' + '}', name.to_s)
